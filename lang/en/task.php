...
$string['tasktype_help'] = 'Controls the icon and styling of the Task description panel. The available types (and the CSS classes each maps to) are configured in the site-wide "Task types" setting.';
$string['tasktypes'] = 'Task types';
$string['tasktypes_desc'] = 'One Task type per line, in the format <code>shortname|name|CSS classes</code>, e.g. <code>explore|Explore|c4lv-mu-explore c4lv-mu-explore1</code>. The shortname cannot contain spaces and must be unique. The name is shown in the per-activity "Task type" dropdown; the CSS classes are added to the description panel for activities using that type.';
$string['tasktypes_error_empty'] = 'Enter at least one Task type.';
$string['tasktypes_error_format'] = 'These lines are not valid "shortname|name|CSS classes" Task type definitions, or repeat a shortname already used above: {$a}';
