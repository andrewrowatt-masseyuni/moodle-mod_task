...
/**
 * Event fired when a user posts a reply.
 *
 * @package    mod_task
...
class reply_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreplycreated', 'mod_task');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created a reply with id '{$this->objectid}' " .
