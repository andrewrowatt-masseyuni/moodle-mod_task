...
/**
 * Event fired when a student posts a top-level response.
 *
 * @package    mod_task
...
class response_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponsecreated', 'mod_task');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created a response with id '{$this->objectid}' " .
