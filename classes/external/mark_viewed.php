...
/**
 * Web service: record that the user has viewed the Task (clears the badge).
 *
 * @package    mod_task
 * @copyright  2026 Andrew Rowatt <A.J.Rowatt@massey.ac.nz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mark_viewed extends external_api {
    /**
    ...
    public static function execute(int $cmid): array {
        ...
        manager::mark_viewed((int)$cm->instance, (int)$USER->id);
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'status' => new external_value(PARAM_BOOL, 'Whether the view was recorded'),
        ]);
    }
}
